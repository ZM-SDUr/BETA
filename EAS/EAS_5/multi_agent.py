...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = '../results2/result-5/results5'
LOG_FILE = '../results2/result-5/results5/log'
TEST_LOG_FOLDER = './test_results/'
TRAIN_TRACES = '../train2/class5/'

NN_MODEL = '../results2/result-5/results4/nn_model_ep_18000.ckpt'
#NN_MODEL = None
