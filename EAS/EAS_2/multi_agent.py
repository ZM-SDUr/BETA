...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = '../results-HD/result-2/results5'
LOG_FILE = '../results-HD/result-2/results5/log'
TEST_LOG_FOLDER = './test_results-HD/'
TRAIN_TRACES = '../train2/class2/'

#NN_MODEL = '../results5-HD/result-2/results4/nn_model_ep_18000.ckpt'
NN_MODEL = None
