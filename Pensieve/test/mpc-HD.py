...
def main(arg1, arg2):
    ...
    while True:  # serve video forever
        ...
        reward = HD[bit_rate] - REBUF_PENALTY * rebuf\
        ...
        for full_combo in CHUNK_COMBO_OPTIONS:
            ...
            for position in range(0, len(combo)):
                ...
                curr_buffer += 4
                bitrate_sum += VIDEO_BIT_RATE[chunk_quality]/1000.
                HD_sum +=HD[chunk_quality]
                LOG_sum += LOG[chunk_quality]
                smoothness_diffs += abs(HD[chunk_quality] - HD[last_quality])
            ...
            reward = HD_sum - (REBUF_PENALTY*curr_rebuffer_time) - (smoothness_diffs)
