...
def parse_args():
    ...
    parser.add_argument('--save-dir', type=str, required=True, help="directory"
                        " to save testing and intermediate results5.")
...
class Genet:
    """Genet_new implementation with Bayesian Optimization.

    Args
        config_file: configuration file which contains the large ranges of all parameters.
        save_dir: a path to save results5.
