...
def main():
    ...
    save_dirs = [os.path.join('results5/cc/evaluate_synthetic_dataset', 'trace_{:05d}'.format(i))
    ...
    ax.set_xticklabels(['RL1', 'RL2', 'RL3', 'Genet_new'], rotation=30, ha='right', rotation_mode='anchor')
