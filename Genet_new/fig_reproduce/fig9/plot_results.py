...
def main():
    ...
    ax1.bar( x[0] ,UDR_1 ,yerr=0 ,width=column_wid ,error_kw=dict(lw=eline_wid, capsize=capsize_wid),  color='C0' )
    ax1.bar( x[1] ,UDR_2 ,yerr=0 ,width=column_wid ,error_kw=dict(lw=eline_wid, capsize=capsize_wid),  color='C0' ,alpha=1, hatch='x'  )
    ax1.bar( x[2] ,UDR_3 ,yerr=0 ,width=column_wid ,error_kw=dict(lw=eline_wid, capsize=capsize_wid),  color='C0' ,alpha=1, hatch='/' )

    ax1.bar( x[3] ,genet ,yerr=0 ,width=column_wid ,error_kw=dict(lw=eline_wid, capsize=capsize_wid),  color='C2' ,alpha=1 )
    ...
    # plt.show()
    plt.savefig('fig9_abr'+'_'+str(args.seed) +'.png')
