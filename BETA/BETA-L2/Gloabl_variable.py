...
M_IN_K = 1000.0
BIT_IN_BYTE = 8
REBUF_PENALTY = 30  # 4.3# 1 sec rebuffering -> 3 Mbps
SMOOTH_PENALTY = 1

RANDOM_SEED = 42
RAND_RANGE = 1000

LOG_FILE = './log_file_4G-HD/'
MODEL_SAVED = './model-L12/'
...
#TRACES_TCP_test  = './OPT_and_Model_con/classified_trace/L'+str(2)+'/'#'./Selected_trace/raw/' #'./TCP_trace_process_after/' + trace_file_list[0] + '/'
TRACES_TCP_train = '../L2/'
