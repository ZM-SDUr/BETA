...
def main(arg1, arg2, model_num):
    ...
    Model_reward_list = []
    get_model = tf.keras.models.load_model('./model-L15/actor_model' + str(model_num))
    ...
    while True:
        ...
        action_index,action = find_closest(VIDEO_BIT_RATE,action)
        ...
        if end_of_video:
            ...
            log_path = "./test_results/" + all_file_names[net_env.trace_idx - 1]
