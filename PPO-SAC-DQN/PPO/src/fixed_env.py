...
BITRATE_LEVELS = 8
VIDEO_BIT_RATE = np.array([200., 800., 2200., 5000., 10000.,18000.,32000.,50000.])  # Kbps
...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, random_seed=RANDOM_SEED):
        ...
        self.mahimahi_start_ptr = 301
        # randomize the start point of the trace
        # note: trace file starts with time 0
        self.mahimahi_ptr = 301
        ...
        for bitrate in range(BITRATE_LEVELS):
            ...
            for line in range(TOTAL_VIDEO_CHUNCK):
                self.video_size[bitrate].append(int(500*VIDEO_BIT_RATE[bitrate]))
