...
from .MPC_expert_v6_next import ABRExpert
...
def train_iml_v4(train_epoch, net_env, valid_env, args, add_str, summary_dir,device):
    ...
    with (open(log_file_name + '_record', 'w') as log_file, \
        ...
        expert = ABRExpert(net_env, rebuffer_penalty, smooth_penalty, 1, \
        ...
        for _ in range(train_epoch):
            ...
            for _ in range(steps_in_episode):
                ...
                if bit_rate_opt > bit_rate_:
                    bit_rate_opt = 2
                elif bit_rate_opt == bit_rate_:
                    bit_rate_opt = 1
                else:
                    bit_rate_opt = 0
                ...
                bit_rate_ = calculate_from_selection(selection, last_bit_rate)
