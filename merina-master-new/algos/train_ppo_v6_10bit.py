...
from .AC_net_v6_10bit import Actor, Critic
from .beta_vae_v6 import BetaVAE
from .test_v5_10bit import valid
        ...
        while True:
            ...
            while memory.return_size() < args.explo_num * args.ro_len -1:
                ...
                for _ in range(steps_in_episode):
                    ...
                    state[14, -1] = float(delay) / M_IN_K / BUFFER_NORM_FACTOR
            ...
            for _ in range(ppo_ups):
                ...
                print('prob_value_old',prob_value_old)
                ...
                # clip loss
                print('batch_advantages', batch_advantages[10])
                ...
                print('loss_clip_actor', loss_clip_actor)
