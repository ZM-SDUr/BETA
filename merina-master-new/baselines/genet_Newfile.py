...
NN_MODEL_LOG = '/home/ubuntu/Whr/EAS/Genet_new/results_2/abr/genet_10bit/log/bo_6/model_saved/nn_model_ep_600.ckpt'
NN_MODEL_LIN = '/home/ubuntu/Whr/EAS/Genet_new/results_2/abr/genet_10bit/lin/bo_6/model_saved/nn_model_ep_2500.ckpt'
#NN_MODEL= None
...
def main():
    ...
    for ii in range(i):
        ...
        log_path = log_file_init + str(ii+1) + '/'+ 'log_test_genet' + '_' + all_file_names[net_env.trace_idx]
