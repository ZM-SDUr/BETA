...
NN_MODEL_PPO = '/home/ubuntu/Whr/EAS/new_val/results_master_gener/4/gener_3/model_saved/nn_model_ep_98700.ckpt'
NN_MODEL_LOG = '/home/ubuntu/Whr/EAS/new_val/results_master_gener/log/4/ppo/model_saved/nn_model_ep_84700.ckpt'
#NN_MODEL= None
...
def main():
    ...
    for ii in range(i):
        ...
        log_path = log_file_init + str(ii+1) + '/'+ 'log_test_gener_ppo_4' + '_' + all_file_names[test_env.trace_idx]
