...
VIDEO_BIT_RATE = [200, 400 ,800, 1200, 2200, 3300, 5000, 6500, 8600, 10000, 12000]  # Kbps
BUFFER_NORM_FACTOR = 10.0
CHUNK_TIL_VIDEO_END_CAP = 150
M_IN_K = 1000.0
REBUF_PENALTY_lin = 12 #dB
REBUF_PENALTY_log = 4.09
SMOOTH_PENALTY = 1
DEFAULT_QUALITY = 1  # default video quality without agent
RANDOM_SEED = 42
RAND_RANGE = 1000
#NN_MODEL = '../models/baselines/pensieve/pretrain_linear_reward.ckpt'
NN_MODEL = '/home/ubuntu/Whr/EAS/Genet_new/results5/abr/udr_valtrace_11bit_next/seed_30/model_saved/nn_model_ep_50000.ckpt'
#NN_MODEL= None
...
TEST_LOG_FILE_Newfile = '../Results_TEST_10_level/test_next/lin/Newfile_CUHK/'
...
TEST_LOG_FILE_Newfile_LOG = '../Results_TEST_10_level/test_next/log/Newfile_CUHK/'
...
def main():
    ...
    assert len(VIDEO_BIT_RATE) == BITRATE_DIM
    ...
    for ii in range(i):
        ...
        log_path = log_file_init + str(ii+1) + '/'+ 'log_test_a_next' + '_' + all_file_names[test_env.trace_idx]
