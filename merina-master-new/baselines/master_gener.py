...
NN_MODEL = '/home/ubuntu/Whr/EAS/new_val/results_master_gener/7/gener_2/model_saved/nn_model_ep_111300.ckpt'
NN_MODEL_LOG = '/home/ubuntu/Whr/EAS/new_val/results_master_gener/log/4/gener_2/model_saved/nn_model_ep_91700.ckpt'
#NN_MODEL= None
...
def main():
    ...
    for ii in range(i):
        ...
        log_path = log_file_init + str(ii+1) + '/'+ 'log_test_ma_ge_4' + '_' + all_file_names[test_env.trace_idx]
