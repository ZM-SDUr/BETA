...
NN_MODEL_CRI_TUR = '/home/ubuntu/Whr/EAS/new_val/results_critic_turmoil/abr/critic_tur/3/model_saved/nn_model_ep_294500.ckpt'
NN_MODEL_LIN = '/home/ubuntu/Whr/EAS/new_val/results_new_val_1/abr/pensieve/lin/model_saved/nn_model_ep_116400.ckpt'
#NN_MODEL= None
LOG_FILE_OBE = '../Results/test/lin/oboe/log_test_newval'
LOG_FILE_3GP = '../Results/test/lin/3gp/log_test_newval'
LOG_FILE_FCC = '../Results/test/lin/fcc/log_test_newval'
LOG_FILE_FH = '../Results/test/lin/fh/log_test_newval'
LOG_FILE_PUF = '../Results/test/lin/puffer/log_test_newval'
LOG_FILE_PUF2 = '../Results/test/lin/puffer2/log_test_newval'
TEST_LOG_FILE_Newfile = '../Results_10bit/test/lin/Newfile_CUHK/'

LOG_FILE_OBE_LOG = '../Results/test/log/oboe/log_test_newval'
LOG_FILE_3GP_LOG = '../Results/test/log/3gp/log_test_newval'
LOG_FILE_FCC_LOG = '../Results/test/log/fcc/log_test_newval'
LOG_FILE_FH_LOG = '../Results/test/log/fh/log_test_newval'
LOG_FILE_PUF_LOG = '../Results/test/log/puffer/log_test_newval'
LOG_FILE_PUF2_LOG = '../Results/test/log/puffer2/log_test_newval'
...
def main():
    ...
    for ii in range(i):
        ...
        log_path = log_file_init + str(ii+1) + '/'+ 'log_test_cri_tur_3' + '_' + all_file_names[test_env.trace_idx]
        ...
        with tf.compat.v1.Session() as sess:
            ...
            actor = a3c_ppo.ActorNetwork(sess,
            ...
            while True:  # serve video forever
                ...
                entropy_record.append(a3c_ppo.compute_entropy(action_prob[0]))
