...
TEST_LOG_FILE_Newfile = '../Results_Newfile_next/test/lin/Newfile_CUHK/log_test_a_next'
...
TEST_LOG_FILE_Newfile_LOG = '../Results_Newfile_next/test/log/Newfile_CUHK/log_test_a_next'
