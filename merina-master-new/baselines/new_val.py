...
NN_MODEL_PPO = '/home/ubuntu/Whr/EAS/new_val/results_new_val_1/abr/pensieve_ppo/6/model_saved/nn_model_ep_148500.ckpt'
...
def main():
    ...
    for ii in range(i):
        ...
        log_path = log_file_init + str(ii+1) + '/'+ 'log_test_newval' + '_' + all_file_names[test_env.trace_idx]
